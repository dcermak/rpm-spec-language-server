...
def test_container_mount_path_root_accepts_full_path() -> None:
    server = create_rpm_lang_server(container_mount_path="/")
    uri = "file:///home/me/specs/hello_world.spec"

    assert server._spec_path_from_uri(uri) == "/home/me/specs/hello_world.spec"
